...
const Glimmer = () => {
  ...
  return (
    <div class="relative bg-NAFBlue pb-20">
      ...
      <EventImagesCard button="Visit Picrew" href="/pi crew" bgColor={bgcolor} title="PICREW" date="8 Feb to 17 Mar, Online" imgs={imgs} content="Join us for a night of unforgettable movies will "></EventImagesCard>
