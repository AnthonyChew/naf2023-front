...
const WhatsOn = () => {
  return (
    <div>
      ...
      {/* Laptop and Above */}
      <div class="hidden lg:block bg-NAFPink bg-cover min-h-screen relative overflow-hidden" style={{ backgroundImage: `url(${WhatsOnBg})` }}>
      ...
      {/* Tablet and Mobile */}
      <div class="bg-NAFPink bg-cover relative overflow-hidden" style={{ backgroundImage: `url(${WhatsOnBg})` }}>
        <div class="flex relative flex-col items-center">
          <img class="mt-28 mb-28 z-20" src={WhatsOnLogo}></img>
          <img class="absolute z-10" src={WhatsOnOrbit}></img>
        </div>
        ...
        <div class="text-center mb-10">
          <div className="swiper-custom-pagination-2" />
        </div>
