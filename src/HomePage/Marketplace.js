...
const Marketplace = () => {
  return (
    <div class="bg-NAFPink flex relative flex-col min-h-screen overflow-hidden justify-center">
      <div class="mx-auto my-0 w-[90%] md:w-[80%] lg:w-2/3 h-1/4 text-center z-20">
      ...
      <img src={MarketPlaceYellow4Star1} class="absolute top-[3%] left-[0%] z-20 hidden lg:block"></img>
      <img src={MarketPlacePurpleDot} class="absolute top-[21%] left-[9%] z-20 hidden lg:block"></img>
      <img src={MarketPlaceOrange8Star1} class="absolute top-[9%] left-[12.4%] z-20 hidden lg:block"></img>
      <img src={MarketPlaceBlue4Star1} class="absolute top-[5.2%] left-[24.51%]"></img>
      <img src={MarketPlaceYellow8Star1} class="absolute top-[6.3%] left-[31.25%] hidden lg:block"></img>
      <img src={MarketPlacePurple8Star1} class="absolute top-[3.3%] left-[45%] hidden lg:block"></img>
      <img src={MarketPlaceOrange4Star1} class="absolute top-[10.9%] right-[39%] hidden lg:block"></img>
      <img src={MarketPlaceBlue8Star1} class="absolute top-[2%] right-[27.8%] z-20 hidden lg:block"></img>
      <img src={MarketPlacePurple8Star2} class="absolute top-[10.5%] right-[17%] z-20"></img>
      <img src={MarketPlaceOrangeDot} class="absolute top-[5%] right-[10.7%] hidden lg:block"></img>
      <img src={MarketPlaceWhite4Star1} class="absolute top-[9.4%] right-[1%] hidden lg:block"></img> 

      <img src={MarketPlaceBlue8Star1} class="absolute top-[26.4%] left-[1%]"></img>
      <img src={MarketPlaceWhite4Star2} class="absolute top-[27%] left-[13%] hidden lg:block"></img>
      <img src={MarketPlacePurple4Star1} class="absolute top-[18%] left-[26%] hidden lg:block"></img>
      <img src={MarketPlaceBlue4Star2} class="absolute top-[18%] left-[41.3%] hidden lg:block"></img>
      <img src={MarketPlaceWhiteDot} class="absolute top-[27.8%] left-[52.7%] hidden lg:block"></img>
      <img src={MarketPlaceYellow4Star2} class="absolute top-[21.4%] right-[32.5%] hidden lg:block"></img>
      <img src={MarketPlaceWhiteDot} class="absolute top-[27%] right-[27%] hidden lg:block"></img>
      <img src={MarketPlaceBlue8Star2} class="absolute top-[25%] right-[1.5%] hidden lg:block"></img>

      <img src={MarketPlaceWhite4Star3} class="absolute top-[50%] left-[8%] hidden lg:block"></img>
      <img src={MarketPlacePurple4Star2} class="absolute bottom-[39%] right-[4.5%] hidden lg:block"></img>

      <img src={MarketPlaceWhiteDot} class="absolute bottom-[6%] left-[2.6%] hidden lg:block"></img>
      <img src={MarketPlacePurple8Star3} class="absolute bottom-[13%] left-[1%]"></img>
      <img src={MarketPlaceYellow4Star3} class="absolute bottom-[8.5%] left-[16.5%] z-20 hidden lg:block"></img>
      <img src={MarketPlaceOrange8Star2} class="absolute bottom-[23.2%] left-[25%] z-20 hidden lg:block"></img>
      <img src={MarketPlaceWhite4Star4} class="absolute bottom-[1.5%] left-[31.7%]"></img>
      <img src={MarketPlacePurple8Star4} class="absolute bottom-[15.7%] left-[39.3%] hidden lg:block"></img>
      <img src={MarketPlaceWhiteDot} class="absolute bottom-[7.6%] left-[47.4%] hidden lg:block"></img>
      <img src={MarketPlaceBlue4Star3} class="absolute bottom-[12.4%] right-[38%] hidden lg:block"></img>
      <img src={MarketPlaceOrange8Star3} class="absolute bottom-[5.5%] right-[25.5%] hidden lg:block"></img>
      <img src={MarketPlaceWhite4Star5} class="absolute bottom-[28.6%] right-[27.7%] hidden lg:block"></img>
      <img src={MarketPlaceYellow8Star2} class="absolute bottom-[18.8%] right-[14.8%] hidden lg:block"></img>
      <img src={MarketPlaceWhiteDot} class="absolute bottom-[9.5%] right-[19.7%] z-20 hidden lg:block"></img>
      <img src={MarketPlaceBlue4Star4} class="absolute bottom-[1.7%] right-[2%]"></img>
      <img src={MarketPlaceOrangeDot} class="absolute bottom-[26.1%] right-[2.8%] hidden lg:block"></img>

      <img src={MarketPlaceOrbit1} class="absolute w-[20%] top-[1%] left-[0%] z-10 hidden lg:block"></img>
      <img src={MarketPlaceOrbit2} class="absolute w-[19%] top-[-2%] right-[17%] z-10 hidden lg:block"></img>
      <img src={MarketPlaceOrbit3} class="absolute w-[21%] bottom-[5%] left-[15%] z-10 hidden lg:block"></img>
      <img src={MarketPlaceOrbit4} class="absolute w-[21%] bottom-[1%] right-[14.5%] z-10 hidden lg:block"></img>
    </div>
  );
};
