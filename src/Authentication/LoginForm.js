  ...
  return (
    <form autoComplete="off" onSubmit={logIn}>
      ...
      <button
        ...
        class="w-fit ml-auto mr-auto text-xl bg-blue-600 text-white border-4 border-black bg-#0071C6 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-large rounded-lg text-sm px-3 py-2.5 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
      >
        Log in
      </button>
