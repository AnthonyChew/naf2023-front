...
const ThemexCAC = (props) => {
    return (
        <div class="relative mx-auto w-[80%] mt-20">
            <div class="relative w-full mt-5">
                <div class="font-syne bg-gray-300 py-2 border-2 border-black border-b-0 w-[32%] sm:w-[17%] font-bold text-center text-xl">{props.title}</div>
            </div>
            <div class="relative flex border-solid bg-white border-2 border-black w-full shadow-[20px_20px_0_0_rgba(0,0,0)] p-[2%]">
