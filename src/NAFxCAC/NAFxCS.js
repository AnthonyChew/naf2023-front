...
import CSTextLogo from './svgs/CSTextLogo.png'
import CSLogo from './svgs/CSLogo.png'
import CSMiniAd from './svgs/CSMiniAd.png'
import CS_1 from './svgs/CS_1.JPG'
import CS_2 from './svgs/CS_2.JPG'
import CS_3 from './svgs/CS_3.JPG'
import CS_4 from './svgs/CS_4.jpg'
import CS_5 from './svgs/CS_5.jpg'
...
const NAFxCS = () => {
    ...
    return (
        <div class="relative bg-NAFBlue py-[50px]">
            ...
            <GalleryxCAC title="CS Gallery"></GalleryxCAC>
