  ...
  return (
    <div class="flex relative items-center min-h-screen bg-NAFPink bg-cover overflow-hidden" style={{ backgroundImage: `url(${CartBg})` }}>
      <div class = "absolute left-[11%] absolute top-[7%] w-[100%] z-[1] ">
        <div class="flex top-[19%] w-[68%] h-fit mt-[5%] mb-[14.5%] mr-[10%] ml-[6%] border-4 border-black shadow-[20px_20px_0_0_rgba(255,255,0)]">
          <div class="absolute left-[0%] top-[2.5%] z-[2] max-w-[100%] border-4 bg-white border-black shadow-[20px_20px_0_0_rgba(0,113,198)] shadowborder-black">
      ...
      <div class = "right-[10%] bottom-[20%]">
        <button type="button" class="text-white bg-#0071C6 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-large rounded-lg text-sm px-3 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
            Check Out
        </button>
      </div>
