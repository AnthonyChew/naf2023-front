    ...
    return (
        ...
        <div class="flex flex-row">
            ...
            <div class="flex flex-col flex-1 justify-center gap-1">
                ...
                {/* <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto" id={"model-"+index} tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-modal="true" role="dialog">
