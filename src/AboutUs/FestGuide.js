...
const FestGuide = () => {
  ...
  return (
    ...
    <div class="flex relative lg:min-h-screen bg-NAFYellow  overflow-hidden md:pl-20  md:pr-20">
      ...
      <div class='2xl:w-[70%] 2xl:mx-auto'>
        ...
        ></img> */}
          ...
          <div class="lg:relative lg:flex-1 basis-full self-center mb-20 w-min overflow-hidden hidden lg:block">
            <div class="mx-auto lg:w-[80%] h-fit bg-white item align-center border-4 border-black shadow-[15px_20px_0_0_rgba(0,0,0)]">
              <AppleHeader></AppleHeader>
              <div class="p-5 w-[100%] h-full mx-auto my-auto">
                <Swiper
