    ...
    return (
        <div class="bg-NAFPurple bg-cover relative py-20 pb-40">
            ...
            <div class='relative z-10'>
                ...
                <div class="w-[90%] md:w-[68%] mx-auto font-syne text-white">
