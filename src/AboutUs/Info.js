  ...
  return (
    <div class="relative bg-NAFBlue py-20">
      ...
      <div class='lg:w-[70%] mx-auto'>
        ...
        <div class="flex flex-col md:flex-row md:pt-10 px-5">
          <div class="flex basis-1/2 text-sm justify-center items-center z-20 md:order-first order-last">
          ...
          <div class="flex relative basis-1/2 md:my-10 justify-center items-center z-20 ">
            <img src={ArtFestivalLogo} class="lg:w-[70%] w-[50%] z-10 "></img>
            <img src={Orbit} class="absolute mb-20top-[27%] w-[50%] md:w-auto md:top-[4%] lg:top-[-5%]"></img>
