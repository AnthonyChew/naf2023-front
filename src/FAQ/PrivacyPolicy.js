...
export default function PrivacyPolicy() {
  const header1 = "text-2xl font-bold my-5";
  const header2 = "text-2xl font-bold my-5";
  const header3 = "text-xl font-semibold my-2";

  const ul = "list-disc list-inside ml-5";
  const paragraph = "my-3 inline";
  return (
    <div class='relative bg-gray-300 pb-[5%] w-fit pt-[2%] px-5 text-black font-syne'>
      <div class='md:px-72 w-fit'>
        <header>
          <div>
            <span >
              <p class={header1}> Privacy Policy for NTU Arts Festival</p>
            </span>
          </div>
        </header>
        ...
        <section class="">
          <div class="" section-language="en">
            <div id="md_en" data-target="out_en" className="agreement_md">
              <h1 class={header2}>Privacy Policy</h1>
