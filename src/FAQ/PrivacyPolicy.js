...
export default function PrivacyPolicy() {
  const header1 = "text-2xl font-bold my-5 text-white";
  const header2 = "text-2xl font-bold my-5 text-white";
  const header3 = "text-xl font-semibold my-2 text-white";

  const ul = "list-disc list-inside ml-5 text-white";
  const paragraph = "my-3 inline text-white";
  return (
    <div class='relative min-h-screen  bg-NAFBlue pb-[5%] pt-[2%] lg:px-72 px-5 overflow-x-hidden'>
      <div class=''>
        <header>
          <div>
            <span >
        ...
        <section class="">
          <div class="" section-language="en">
            <div id="md_en" data-target="out_en" className="agreement_md">
              ...
              <h1 class={header1}>Interpretation and Definitions</h1>
              <h2 class={header1}>Interpretation</h2>
              <p class={paragraph}>
              ...
              <h2 class={header1}>Definitions</h2>
              ...
              <ul class={ul}>
                ...
                <li>
                  ...
                  "We", "Us" or "Our" in this Agreement) refers to NTU Arts
                  Festival.
                </li>
                <li>
                ...
                <li>
                  <strong>Website</strong> refers to NTU Arts Festival,
                  accessible from{' '}
                  <a
                    href="https://www.naf.sg"
              ...
              <div>
                <h1 class={header1}>Collecting and Using Your Personal Data</h1>
                <h2 class={header2}>Types of Data Collected</h2>
                <h3 class={header3}>Personal Data</h3>
                <p class={paragraph}>
                ...
                <h3 class={header3}>Usage Data</h3>
                ...
                <h3 class={header3}>Information from Third-Party Social Media Services</h3>
                <p class={paragraph}>
              ...
              <h3 class={header3}>Tracking Technologies and Cookies</h3>
              <p class={paragraph}>
              ...
              <h2 class={header2}>Use of Your Personal Data</h2>
              ...
              <h2 class={header2}>Retention of Your Personal Data</h2>
              <p class={paragraph}>
              ...
              <h2 class={header2}>Transfer of Your Personal Data</h2>
              <p class={paragraph}>
              ...
              <h2 class={header2}>Disclosure of Your Personal Data</h2>
              <h3 class={header3}>Business Transactions</h3>
              <p class={paragraph}>
              ...
              <h3 class={header3}>Law enforcement</h3>
              <p class={paragraph}>
              ...
              <h3 class={header3}>Other legal requirements</h3>
              <p class={paragraph}>
              ...
              <h2 class={header2}>Security of Your Personal Data</h2>
              <p class={paragraph}>
                ...
                <li>
                  ...
                  <p class={paragraph}>
                    ...
                    <a
                      ...
                      target="_blank"
                    >
                      https://www.ocbc.com/group/policies
                    </a>
                  </p>
                </li>
              </ul>
              ...
              <h1 class={header1}>Children's Privacy</h1>
              <p class={paragraph}>
              ...
              <h1 class={header1}>Links to Other Websites</h1>
              <p class={paragraph}>
              ...
              <h1 class={header1}>Changes to this Privacy Policy</h1>
              <p class={paragraph}>
              ...
              <ul class={ul}>
                <li>By email: ntuartsfestival@gmail.com</li>
              </ul>
            </div>
