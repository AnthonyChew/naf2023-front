  ...
  return (
    <div class="overflow-hidden relative h-auto md:min-h-screen w-full bg-NAFBlue pt-12 md:pb-0 pb-20 px-[5%] lg:px-20">
      ...
      <div class='lg:w-[70%] lg:mx-auto'>
        ...
        <div class="z-10 relative mb-[3%] mx-[10%] lg:mx-[15%] font-syne text-white text-center text-xs sm:text-sm md:text-md lg:text-xl">
          Browse through the gallery to find out more about what to expect during the workshop!
        </div>
